...
const DIMENSIONS = {
  ...
  partnerCount: {
    ...
    detect: (text) => {
      ...
      if (/我和两个朋友|我和2个朋友|我跟两个朋友|我跟2个朋友|我和另外两个人|我跟另外两个人|加上我.*3/.test(text)) return { val: 3, prompt: '3人1+2主导/三角色/均分' };
      ...
      if (/五个|5人|5个人|五个人|五位|5位|我们五个|5个/.test(text)) return { val: 5, prompt: '4-5人均衡治理/加盟合伙' };
      if (/四个|4人|4个人|四个人|四位|4位|我们四个|4个/.test(text)) return { val: 4, prompt: '4-5人1天使+3执行/均分治理' };
      if (/三个|3人|3个人|三个人|三方|甲.*乙.*丙|我们三个|3个/.test(text)) return { val: 3, prompt: '3人1+2主导/三角色/均分' };
      if (/两个股东|两个合伙人|两个|2人|2个人|两个人|一个出.*一个|我俩|我们俩|我和一个|我和我|我和另|2个|我和朋友|朋友和我|我跟我朋友|我和另一个|两人/.test(text)) return { val: 2, prompt: '2人资金+运营/资金+技术/夫妻' };
  ...
  governance: {
    ...
    detect: (text) => {
      ...
      if (/资源股|资源入股|客户资源|客户.*资源|政府资源|带来客户|生源|渠道资源/.test(text)) hits.push('资源股安排');
